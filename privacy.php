...
<p>this privacy policy sets out how GANGNAM GROCERIES uses and protects any information that you give GANGNAM GROCERIES when you use this website. </p> 
<p>GANGNAM GROCERIES is committed to ensuring that your privacy is protected. should we ask you to provide certain information by which you can be identified when using this website, then you can be assured that it will only be used in accordance with this privacy statement.</p>
<p>GANGNAM GROCERIES may change this policy from time to time by updating this page. you should check this page from time to time to ensure that you are happy with any changes.</p>
<p>this policy is effective from October 12th, 2012.</p>
