...
<td><input type='password' name='confirm_password' id='confirm_password' maxlength="50" /></td>
</tr>
<!-- FNAME -->
<tr>
...
<td><input type='text' name='zip' id='zip' maxlength="50" /></td>
</tr>
<!-- PHONE -->
<tr>
<td><label for='phone' >phone. </label></td>
<td><input type='text' name='phone' id='phone' maxlength="50" /></td>
</tr>
<!-- CCN -->
<tr>
